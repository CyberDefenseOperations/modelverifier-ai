...
Mappings to 8 frameworks. 8 deployment profiles. 15-control baseline.
...
dataset.profiles[]            8 deployment profiles with trigger conditions
...
8 deployment profiles with machine-evaluable `trigger_conditions` against
...
| `aicm` | CSA AI Controls Matrix v1.0.3 |
